...
export default function Header() {
  ...
  const finalNav = user?.user_id ? user.role === "ADMIN" ? adminNav : userNav : guestNav;
          ...
          <div className="navbar-start">
            <div className="dropdown">
              ...
              <ul
                ...
                <li>
                <a onClick={hdlProduct}>โต๊ะอาหาร</a>
              </li>
                <li>
                  <a>ติดต่อเรา</a>
                </li>
            ...
            <a className="btn btn-ghost text-xl text-white">ระบบจองโต๊ะอาหาร</a>
          </div>
