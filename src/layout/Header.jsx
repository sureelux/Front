      ...
      <div className="flex-1">
        <div className="navbar">
          <div className="navbar-start">
                  ...
                  <details>
                    ...
                    <ul className="p-2 bg-white rounded-t-none text-black leading-7 w-32">
                      {typeuser.map((type, index) => (
                        <li
                          key={index}
                          onClick={() => TypeTableUser(type.type_name)}
                        >
                          {type.type_name}
                        </li>
                      ))}
            ...
            <a
              className="btn btn-ghost text-2xl text-white flex items-center"
              onClick={() => navigate("/")}
            >
              <img
                src="img/suree.png"
      ...
      {user?.user_id ? (
        <div className="flex-none gap-2">
          <span className="text-white mr-5 text-lg">
            สวัสดี, <span className="text-sm">คุณ {user.username}</span>
          </span>
        ...
        <div>
          <button
            className="text-white mr-5 text-lg"
