          ...
          <div className="navbar-start">
            <div className="dropdown">
              ...
              >
                ...
                <li>
                  <a onClick={hdlTables}>โต๊ะอาหารทั้งหมด</a>
                </li>
                <li>
                  <details>
                ...
                <li>
                  <a onClick={hdlContact}>ติดต่อเรา</a>
                </li>
              </ul>
            </div>
            <a className="btn btn-ghost text-xl text-white" onClick={hdlHome}>
              ระบบจองโต๊ะอาหาร
            </a>
          </div>
