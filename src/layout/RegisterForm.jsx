...
>
  <div className="flex absolute top-0 left-0 mt-20">
    <Link
      to="/login"
      className="text-black text-2xl rounded-full p-2 "
    >
  ...
  <div className="flex flex-col justify-center items-center p-16 border w-11/12 max-w-2lg mx-auto bg-white bg-opacity-90 rounded-xl shadow-2xl mt-24 mb-16">
    <form className="w-full" onSubmit={hdlSubmit}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
        <label className="flex flex-col w-full">
          <div className="label mb-1">
            <span className="label-text font-bold text-gray-700 text-lg">ชื่อผู้ใช้ :</span>
          </div>
          <input
            type="text"
        ...
        <label className="w-full">
          <div className="label">
            <span className="label-text font-bold text-gray-700 text-lg">รหัสผ่าน :</span>
          </div>
          <input
            type="password"
            className="input input-bordered w-8/12 border-gray-400"
        ...
        <label className="w-full">
          <div className="label">
            <span className="label-text font-bold text-gray-700 text-lg">ยืนยันรหัสผ่าน :</span>
          </div>
          <input
            type="password"
            className="input input-bordered w-8/12 border-gray-400"
        ...
        <label className="w-full">
          <div className="label">
            <span className="label-text font-bold text-gray-700 text-lg">ชื่อ :</span>
          </div>
          <input
            type="text"
            className="input input-bordered w-8/12 border-gray-400"
        ...
        <label className="w-full">
          <div className="label">
            <span className="label-text font-bold text-gray-700 text-lg">นามสกุล :</span>
          </div>
          <input
            type="text"
            className="input input-bordered w-8/12 border-gray-400"
        ...
        <label className="w-full">
          <div className="label">
            <span className="label-text font-bold text-gray-700 text-lg">ที่อยู่ :</span>
          </div>
          <input
            type="text"
            className="input input-bordered w-8/12 border-gray-400"
        ...
        <label className="w-full">
          <div className="label">
            <span className="label-text font-bold text-gray-700 text-lg">เบอร์โทรศัพท์ :</span>
          </div>
          <input
            type="tel"
            className="input input-bordered w-8/12 border-gray-400"
        ...
        <label className="w-full">
          <div className="label">
            <span className="label-text font-bold text-gray-700 text-lg">อีเมล :</span>
          </div>
          <input
            type="email"
            className="input input-bordered w-8/12 border-gray-400"
      ...
      <div className="flex gap-4 justify-end items-center mt-6">
        <button type="submit" className="btn bg-green-600 hover:bg-green-700 text-white font-medium">
          สมัครสมาชิก
        </button>
        <button
          type="reset"
        ...
        <Link to="/login" className="btn bg-red-600 hover:bg-red-700 text-white font-medium">
          ย้อนกลับ
        </Link>
      </div>
    </form>
